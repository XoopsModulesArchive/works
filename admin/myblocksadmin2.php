...
function list_blockinstances()
{
	...
	foreach( $block_arr as $bid => $block ) {
		...
		<tr>
			...
			<td class='$class' align='center'>
				<input type='submit' name='addblock[$bid]' value='"._ADD."' class=\"formButton\" />
			</td>
		</tr>
		\n" ;
		$class = ( $class == 'even' ) ? 'odd' : 'even' ;
	...
	echo "
		<tr>
			<td class='foot' align='center' colspan='6'>
				...
				<input type='submit' name='submit' value='"._SUBMIT."' class=\"formButton\" />
			</td>
		</tr>
		</table>
	</form>\n" ;
...
xoops_cp_header() ;
if( file_exists( './mymenu.php' ) ) include_once( './mymenu.php' ) ;
